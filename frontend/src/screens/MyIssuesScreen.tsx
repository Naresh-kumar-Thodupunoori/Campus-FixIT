...
type MyIssuesScreenProps = {
  navigation: NativeStackNavigationProp<MyIssuesStackParamList, 'MyIssues'>;
};

const MyIssuesScreen = ({ navigation }: MyIssuesScreenProps) => {
  const { myIssues, loading, filters, setFilters, fetchMyIssues } = useIssues();
  const [refreshing, setRefreshing] = useState(false);

  useEffect(() => {
    fetchMyIssues(filters.status, filters.category);
  }, [filters]);
